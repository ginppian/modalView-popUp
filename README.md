...
Aditamos para centrar el popup para el iPhone X:
    ...
    public enum PopupLayout {
        ...
        func origin(_ view: UIView, size: CGSize = UIScreen.main.bounds.size) -> CGPoint {
            ...
            if let keyWindow = UIApplication.shared.keyWindow {
                safeAreaTop = CGFloat(keyWindow.safeAreaInsets.top)
            }
            
            switch self {

            case .top: return CGPoint(x: (size.width - view.frame.width) / 2, y: (heightScreen / 2) - (view.frame.height / 2) - safeAreaTop)
